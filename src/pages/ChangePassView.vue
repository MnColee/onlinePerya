    ...
    <main class="w-full flex bg-home-user">
        ...
        <div class="w-full">
            ...
            <section class="w-full flex flex-col">
                <article class="w-full flex items-center justify-center bg-gradient lg:pt-10">
                    <div class="container mx-auto w-full flex flex-col items-center justify-center gap-y-8">
                        <h1 class="font-bold text-xl text-white lg:text-2xl xl:text-3xl ">Change Password</h1>
                        <form class="w-full flex flex-col items-center justify-center gap-x-8 gap-y-8 lg:w-1/2">
                            <div class="bg-input w-full py-3 px-8">
                                <input type="password" name="" id="" class="w-full text-base border-none outline-none ring-0 bg-transparent text-white lg:text-lg xl:text-xl" placeholder="Old Password">
                            </div>
                            <div class="bg-input w-full py-3 px-8">
                                <input type="password" name="" id="" class="w-full text-base border-none outline-none ring-0 bg-transparent text-white lg:text-lg xl:text-xl" placeholder="New Password">
                            </div>
                            <div class="bg-input w-full py-3 px-8">
                                <input type="password" name="" id="" class="w-full text-base border-none outline-none ring-0 bg-transparent text-white lg:text-lg xl:text-xl" placeholder="Confirm Password">
                            </div>
