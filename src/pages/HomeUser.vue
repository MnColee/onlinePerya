    ...
    <main class="w-full flex">
        ...
        <div class="w-full">
            ...
            <section class="flex flex-col">
                <article class="bg-slant w-full flex items-center justify-center py-8 lg:py-14 lg:px-10">
                    <div class="flex flex-col items-center justify-end gap-y-4 relative w-full">
                        <div class="h-full w-full overflow-hidden rounded-2xl">
                            <img src="/img/Rectangle 23.png" alt="" class="h-full w-full">
                        </div>
                        <div class="absolute bottom-12 flex items-center justify-center w-full">
                            <ButtonPrimary @click="toggleGameInstruction" buttonText="Play Now" class="rounded-lg py-3 px-8 shadow-md shadow-blue-300 text-white font-semibold text-base lg:text-3xl xl:text-4xl" />
                        </div>
                    </div>
                ...
                <article class="w-full flex items-center justify-center bg-gradient lg:p-10">
                    <div class="container mx-auto w-full flex flex-col gap-y-8">
                        <h1 class="text-white lg:font-bold xl:text-3xl">Card Games</h1>
                        <div class="w-full grid lg:grid-cols-4 lg:gap-x-3 xl:gap-x-4">
                            <CGCard @click="toggleGameInstruction" />
                        </div>
                        <div class="w-full flex items-center justify-center">
                            <LoadingButton loadmoreText="Load More"/>
                        </div>
...
import CGCard from "../components/CGCard.vue";
