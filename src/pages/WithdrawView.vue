            ...
            <section class="w-full flex flex-col">
                <article class="w-full flex items-center justify-center bg-gradient lg:pt-10">
                    <div class="container mx-auto w-full flex flex-col items-center justify-center gap-y-8">
                        <h1 class="font-bold text-xl text-white lg:text-2xl xl:text-3xl ">Withdraw</h1>
                        <div class="w-full flex items-center justify-center gap-x-8">
                            <button @click="toggleWallet" class="hover:scale-110 duration-300 rounded-lg shadow-sm shadow-white overflow-hidden w-full lg:w-1/3">
                                <img src="/img/gcash.png" alt="" class="h-full w-full">
                            </button>
                            <button @click="toggleWallet" class="hover:scale-110 duration-300 rounded-lg shadow-sm  shadow-white overflow-hidden w-full lg:w-1/3">
                                <img src="/img/paymaya.png" alt="" class="h-full w-full">
                            </button>
                        </div>
                    </div>
                </article>
                <WalletModal :modalWallet="modalWallet" @close-modal="toggleWallet"></WalletModal>
            </section>
        </div>
...
import WalletModal from "./component/WalletModal.vue";
...
const toggleWallet = () => {
    modalWallet.value = !modalWallet.value;
}
